...
{
    /// <inheritdoc />
    public partial class SeedomgDatafordifficultingandregions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("38dd8aa2-1a0f-43a9-8838-8eb7cfd01100"), "Hard" },
                    { new Guid("8792c133-188d-4792-aab2-4a75ef2fc123"), "Easy" },
                    { new Guid("be18b406-fd4d-44d4-87bc-66c7028afd10"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("38dd8aa2-1a0f-43a9-8838-8eb7cfd01100"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("8792c133-188d-4792-aab2-4a75ef2fc123"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("be18b406-fd4d-44d4-87bc-66c7028afd10"));
